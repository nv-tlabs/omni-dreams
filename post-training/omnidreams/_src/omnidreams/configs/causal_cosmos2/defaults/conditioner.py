...
from omnidreams._src.predict2.conditioner import Text2WorldCondition
from omnidreams._src.predict2.configs.video2world.defaults.conditioner import (
    _SHARED_CONFIG,
    ReMapkey,
)
from omnidreams._src.predict2_multiview.conditioner import MVTextAttr
...
class MultiViewConditionCausal(MultiViewCondition):
    ...
    def broadcast(
        ...
        # n_views calculation is needed for split logic
...
MultiViewCausalConditionerConfig: LazyDict = L(MultiViewCausalConditioner)(
    **_SHARED_CONFIG,
...
MultiViewCausalConditionerPerViewDropoutHdmapConfig: LazyDict = L(MultiViewCausalConditioner)(
    **_SHARED_CONFIG_PER_VIEW_DROPOUT,
    view_indices_B_T=L(ReMapkey)(
        input_key="latent_view_indices_B_T",
    ...
    control_input_hdmap_bbox=L(ReMapkey)(
...
def register_conditioner():
    ...
    cs.store(
        ...
        name="video_prediction_multiview_causal_conditioner",
        node=MultiViewCausalConditionerConfig,
    )
    cs.store(
        group="conditioner",
        package="model.config.conditioner",
    ...
    cs.store(
        group="conditioner",
        package="model.config.conditioner",
        name="video_prediction_multiview_causal_conditioner_per_view_dropout_hdmap",
        node=MultiViewCausalConditionerPerViewDropoutHdmapConfig,
    )
