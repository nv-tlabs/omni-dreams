...
from omnidreams._src.omnidreams.configs.causal_cosmos2_multiview.defaults.model import register_model

# modules from causal_multiview
from omnidreams._src.omnidreams.configs.causal_cosmos2_multiview.defaults.net import register_net
...
def make_config() -> Config:
    ...
    import_all_modules_from_package(
        "omnidreams._src.omnidreams.configs.causal_cosmos2_multiview.experiment", reload=True
    )
    try:
