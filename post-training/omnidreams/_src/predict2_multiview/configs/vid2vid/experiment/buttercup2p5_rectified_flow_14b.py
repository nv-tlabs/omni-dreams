...
from omnidreams._src.predict2_multiview.callbacks.every_n_draw_sample_multiviewvideo import (
    EveryNDrawSampleMultiviewVideo,
)
from omnidreams._src.predict2_multiview.callbacks.log_weight import LogWeight

"""
torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=omnidreams/_src/predict2_multiview/configs/vid2vid/config.py -- experiment=buttercup_predict2p5_14b_7views_res720p_fps30_t8_frombase2p5_condprobs0442_joint_alpamayo1capnoviewprefix_allcapsviewprefix_29frames_nofps_uniform
"""
