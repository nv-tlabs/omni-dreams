...
PYTHONPATH=. torchrun --nproc_per_node=8 --master_port=12341 -m omnidreams._src.predict2_multiview.scripts.inference_cli \
    --experiment ${EXP} \
    --ckpt_path ${ckpt_path} \
...
from omnidreams._src.predict2_multiview.scripts.inference import Vid2VidInference
