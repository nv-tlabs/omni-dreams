...
from omnidreams._src.transfer2.configs.vid2vid_transfer.defaults.net import TRANSFER2_CONTROL2WORLD_NET_2B

"""
Usage:
    pytest -s omnidreams/_src/transfer2/networks/minimal_v4_lvg_dit_control_vace_test.py --all -k test_minimal_v1_lvg_edge_dit
"""
