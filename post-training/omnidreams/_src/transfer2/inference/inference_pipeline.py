...
from omnidreams._src.predict2.models.video2world_model import NUM_CONDITIONAL_FRAMES_KEY
from omnidreams._src.predict2.utils.model_loader import (
...
from omnidreams._src.transfer2.inference.utils import (
    get_t5_from_prompt,
...
class ControlVideo2WorldInference:
    ...
    def __init__(
        ...
        config_file: str = "omnidreams/_src/transfer2/configs/vid2vid_transfer/config.py",
    ):
        """
