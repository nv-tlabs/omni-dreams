...
from omnidreams._src.transfer2.auxiliary.sam2.sam2_model import VideoSegmentationModel
...
def _compute_depth_maps(video_np: np.ndarray) -> torch.Tensor | None:
    ...
    """
    try:
        from omnidreams._src.transfer2.auxiliary.depth_anything.video_depth_model import VideoDepthAnythingModel
