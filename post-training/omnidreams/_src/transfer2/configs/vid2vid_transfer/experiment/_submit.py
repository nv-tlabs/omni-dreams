...
"""
AWS:
PYTHONPATH=. python omnidreams/_src/transfer2/configs/vid2vid_transfer/experiment/_submit.py --exp_name=example_experiment_control_layer14 --run_tag=p0 --nnode=2 --partition=pool0_cosmos --ppp=dir_cosmos_misc
Lepton:
PYTHONPATH=. python omnidreams/_src/transfer2/configs/vid2vid_transfer/experiment/_submit.py --exp_name=example_experiment_control_layer14 --run_tag=p0 --nnode=2 --cluster lepton --node_group cosmos-aws-h100-02
"""

import hashlib
import os

from omnidreams._src.transfer2.configs.vid2vid_transfer.experiment.experiment_list import EXPERIMENTS
