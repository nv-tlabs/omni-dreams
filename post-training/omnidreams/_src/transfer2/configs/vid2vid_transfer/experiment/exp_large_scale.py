...
from omnidreams._src.predict2.datasets.cached_replay_dataloader import duplicate_batches_random
...
from omnidreams._src.reason1.configs.default.model_config_qwen import QwenModelConfig, QwenVisionConfig
from omnidreams._src.reason1.models.vlm_qwen_omni import QwenVLBaseModel
from omnidreams._src.reason1.tokenizer.processor import build_tokenizer
...
"""
torchrun --nproc_per_node=1 --master_port=12340 -m scripts.train --dryrun --config=omnidreams/_src/transfer2/configs/vid2vid_transfer/config.py -- experiment=vid2vid_2B_control_720p_control_layer14
"""
