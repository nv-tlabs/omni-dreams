...
from omnidreams._src.transfer2.configs.vid2vid_transfer.defaults.callbacks import register_callbacks
from omnidreams._src.transfer2.configs.vid2vid_transfer.defaults.conditioner import register_conditioner
from omnidreams._src.transfer2.configs.vid2vid_transfer.defaults.dataloader import (
    register_training_and_val_data,
)
from omnidreams._src.transfer2.configs.vid2vid_transfer.defaults.dataloader_local import (
    register_dataloader_local,
)
from omnidreams._src.transfer2.configs.vid2vid_transfer.defaults.model import register_model
from omnidreams._src.transfer2.configs.vid2vid_transfer.defaults.net import register_net
...
def make_config() -> Config:
    ...
    import_all_modules_from_package("omnidreams._src.transfer2.configs.vid2vid_transfer.experiment", reload=True)
    import_all_modules_from_package("omnidreams._src.transfer2.configs.vid2vid_transfer.experiment_av", reload=True)
