...
from omnidreams._src.predict2.configs.common.mock_data import (
...
from omnidreams._src.transfer2.datasets.dataset_provider import get_image_dataset, get_video_dataset
