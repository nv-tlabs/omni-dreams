...
from omnidreams._src.predict2.datasets.local_datasets.dataset_video import get_generic_dataloader, get_sampler
from omnidreams._src.transfer2.datasets.local_datasets.singleview_dataset import SingleViewTransferDataset
...
def register_dataloader_local() -> None:
    ...
    See omnidreams/_src/transfer2/configs/vid2vid_transfer/experiment/exp_posttrain_singleview.py
