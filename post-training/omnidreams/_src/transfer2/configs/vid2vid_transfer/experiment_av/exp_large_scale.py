...
"""
torchrun --nproc_per_node=8 --master_port=12340 -m scripts.train --config=omnidreams/_src/transfer2/configs/vid2vid_transfer/config.py -- experiment=vid2vid_2B_control_480p_control_layer14_av_full_65k_reset_rescheduler
"""
