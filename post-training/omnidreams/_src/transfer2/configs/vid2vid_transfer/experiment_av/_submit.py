...
"""
PYTHONPATH=. python omnidreams/_src/transfer2/configs/vid2vid_transfer/experiment_av/_submit.py --exp_name=vid2vid_2B_control_480p_control_layer14_av --run_tag=node1 --nnode=1 --partition=pool0_datahall_a

PYTHONPATH=. python omnidreams/_src/transfer2/configs/vid2vid_transfer/experiment_av/_submit.py --exp_name=vid2vid_2B_control_true_720p_control_layer14_av_full_65k_low_sigma --run_tag=p0 --nnode=16 --partition=pool0_datahall_a
"""

import os

from omnidreams._src.transfer2.configs.vid2vid_transfer.experiment_av.experiment_list import EXPERIMENTS
from omnidreams._src.transfer2.utils.submit_helper import get_executor
...
def run_experiment(exp_name: str, nnode: int | None, run_tag: str, partition: str, exp_name_tag: str = ""):
    ...
    command = (
        ...
        f"--config=omnidreams/_src/transfer2/configs/vid2vid_transfer/config.py "
