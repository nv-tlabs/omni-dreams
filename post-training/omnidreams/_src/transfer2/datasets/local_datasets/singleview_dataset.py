...
from omnidreams._src.transfer2.datasets.augmentor_provider import get_video_augmentor_v2_with_control
from omnidreams._src.transfer2.utils.input_handling import detect_aspect_ratio
...
if __name__ == "__main__":
    ...
    Usage:
        PYTHONPATH=. python omnidreams/_src/transfer2/datasets/local_datasets/single_view_dataset.py
    """
    import sys
