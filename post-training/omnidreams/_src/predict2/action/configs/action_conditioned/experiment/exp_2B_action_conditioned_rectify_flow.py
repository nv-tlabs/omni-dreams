...
"""
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config=omnidreams/_src/predict2/action/configs/action_conditioned/config.py  -- experiment=cosmos_predict2p5_2B_reason_embeddings_action_conditioned_rectified_flow_bridge_13frame_480_640_ ~dataloader_train.dataloaders
"""
...
"""
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config=omnidreams/_src/predict2/action/configs/action_conditioned/config.py  -- experiment=cosmos_predict2p5_2B_reason_embeddings_action_conditioned_rectified_flow_bridge_13frame_256x320 ~dataloader_train.dataloaders
"""
