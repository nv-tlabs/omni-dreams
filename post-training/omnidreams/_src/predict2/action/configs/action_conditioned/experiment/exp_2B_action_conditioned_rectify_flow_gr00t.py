...
from omnidreams._src.predict2.datasets.cached_replay_dataloader import (
    duplicate_batches,
    duplicate_batches_random,
    get_cached_replay_dataloader,
)
from omnidreams._src.predict2.datasets.dataset_provider import get_image_dataset, get_video_dataset
from omnidreams._src.predict2.datasets.joint_dataloader import IterativeJointDataLoader
from omnidreams._src.predict2.models.video2world_model import HighSigmaStrategy
from omnidreams._src.predict2.text_encoders.text_encoder import EmbeddingConcatStrategy
...
"""
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config=omnidreams/_src/predict2/action/configs/config.py -- experiment=cosmos_predict2p1_2B_reason_embeddings_action_conditioned_rectified_flow_bridge_13frame_480_640_ ~dataloader_train.dataloaders
"""
...
"""
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config=omnidreams/_src/predict2/action/configs/config.py -- experiment=cosmos_predict2p5_2B_action_conditioned_gr00t_gr1_customized_13frame ~dataloader_train.dataloaders
"""
...
"""
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config=omnidreams/_src/predict2/action/configs/config.py -- experiment=cosmos_predict2p5_2B_action_conditioned_gr00t_gr1_customized_13frame_full ~dataloader_train.dataloaders
"""
...
"""
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config=omnidreams/_src/predict2/action/configs/action_conditioned/config.py -- experiment=cosmos_predict2p5_2B_action_conditioned_gr00t_gr1_customized_13frame_full_16nodes_release ~dataloader_train.dataloaders
"""
