...
# ---------------------------------- benchmark ----------------------------------
CUDA_VISIBLE_DEVICES=0 PYTHONPATH=. python omnidreams/_src/predict2/action/inference/inference.py \
--experiment=cosmos_predict2p5_2B_reason_embeddings_action_conditioned_rectified_flow_bridge_13frame_256x320 \
  ...
  --input_video_root /workspace/dir/users/you/path/to/data/ \
...
from omnidreams._src.predict2.action.datasets.dataset_utils import euler2rotm, rotm2euler, rotm2quat
