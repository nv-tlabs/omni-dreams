...
CUDA_VISIBLE_DEVICES=0 PYTHONPATH=. python omnidreams/_src/predict2/action/inference/inference_gr00t_warmup.py \
...
from omnidreams._src.predict2.action.datasets.gr00t_dreams.data.dataset import LeRobotDataset
