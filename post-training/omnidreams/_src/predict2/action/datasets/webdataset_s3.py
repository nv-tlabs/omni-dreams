...
omnidreams._src.imaginaire and maintains compatibility with the output format of dataset_s3.py.
...
from omnidreams._src.imaginaire.datasets.webdataset.config.schema import AugmentorConfig, DatasetConfig, DatasetInfo, TarSample
from omnidreams._src.imaginaire.datasets.webdataset.webdataset import Dataset as WebDatasetBase
from omnidreams._src.imaginaire.lazy_config import instantiate
from omnidreams._src.imaginaire.utils import log
from omnidreams._src.imaginaire.utils.dataset_utils import Resize_Preprocess, ToTensorVideo, euler2rotm, rotm2euler
from omnidreams._src.imaginaire.utils.object_store import ObjectStore
...
if __name__ == "__main__":
    ...
    Run with:
    PYTHONPATH=. python omnidreams/_src/predict2/action/datasets/webdataset_s3.py
    """

    from omnidreams._src.imaginaire.config import ObjectStoreConfig
    from omnidreams._src.imaginaire.datasets.webdataset.config.schema import DatasetConfig, DatasetInfo
