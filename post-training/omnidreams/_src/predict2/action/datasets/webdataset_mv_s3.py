...
PYTHONPATH=. python omnidreams/_src/predict2/action/datasets/webdataset_mv_s3.py
"""
...
from omnidreams._src.imaginaire.datasets.webdataset.config.schema import DatasetInfo, TarSample
from omnidreams._src.imaginaire.utils import log
from omnidreams._src.imaginaire.utils.object_store import ObjectStore
from omnidreams._src.predict2.action.datasets.webdataset_s3 import (
