...
from omnidreams._src.imaginaire.utils.high_sigma_strategy import HighSigmaStrategy as HighSigmaStrategy
...
from omnidreams._src.predict2.models.text2world_model import (
    DenoisePrediction,
    Text2WorldCondition,
        ...
        if is_video_batch:
            if self.config.high_sigma_strategy == str(HighSigmaStrategy.UNIFORM80_2000):
                ...
                if not hasattr(self, "hardcoded_20steps_sigma"):
                    from omnidreams._src.imaginaire.modules.res_sampler import get_rev_ts
