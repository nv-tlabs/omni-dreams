...
from omnidreams._src.predict2.configs.video2world.experiment.reason_embeddings.stage3_2B import (
...
# qwen0.5B configs
"""
torchrun --nproc_per_node=8 --master_port=12341 scripts/train.py --config=omnidreams/_src/predict2/configs/video2world/config.py -- experiment=Stage-c_pt_4-qwen05b-v1p1-Index-26-Size-2B-Res-720-Fps-16-Note-T2V_high_sigma_loss_reweighted
torchrun --nproc_per_node=8 --master_port=12341 scripts/train.py --config=omnidreams/_src/predict2/configs/video2world/config.py -- experiment=Stage-c_pt_4-qwen05b-v1p1-Index-26-Size-2B-Res-720-Fps-16-Note-T2V_high_sigma_loss_reweighted_mock_wo_resume
"""
