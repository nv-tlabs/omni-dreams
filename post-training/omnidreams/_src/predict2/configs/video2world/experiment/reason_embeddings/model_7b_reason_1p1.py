...
"""
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --dryrun --config=omnidreams/_src/predict2/configs/video2world/config.py -- experiment=official_runs_text2world_401_7b_text_to_world_256res_s3

torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config=omnidreams/_src/predict2/configs/video2world/config.py -- experiment=official_runs_text2world_401_7b_text_to_world_256res_s3 job.group=debug
"""
