...
from omnidreams._src.imaginaire.utils.s3_utils import load_from_s3_with_cache
...
_CONFIG_FILE = "omnidreams/_src/predict2/configs/frame_interpolation/config.py"
