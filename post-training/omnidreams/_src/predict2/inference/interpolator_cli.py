...
run_docker -g 3 -i nvcr.io/nvidian/imaginaire4:v10.1.0 \
    "python3 -m omnidreams._src.predict2.inference.interpolator_cli \
...
# 1080p 8-to-32fps
CUDA_VISIBLE_DEVICES=0 torchrun --nproc_per_node=1 -m omnidreams._src.predict2.inference.interpolator_cli \
    --experiment=Interpolation-2B-1080p-8fps-to-32fps-HQ_V6_from_22 \
...
CUDA_VISIBLE_DEVICES=1 torchrun --master_port=29501 --nproc_per_node=1 -m omnidreams._src.predict2.inference.interpolator_cli \
...
run_docker -g 0,1,2,3 -i nvcr.io/nvidian/imaginaire4:v10.1.0 \
    "torchrun --nproc_per_node=4 -m omnidreams._src.predict2.inference.interpolator_cli \
        --experiment=Interpolation-2B-720p-16fps-to-32fps-HQ_V6_from_22 \
        --ckpt_path s3://bucket/cosmos_diffusion_v2/frame_interpolation/Interpolation-2B-720p-16fps-to-32fps-HQ_V6_from_22/checkpoints/iter_000370000 \
        --ckpt_cred credentials/s3_checkpoint.secret \
        --video_pattern 's3://cosmos2_results/qinshengz_Stage-c_pt_4-Index-22-Size-2B-Res-720-Fps-16-Note-HQ_V3_from_20_iter-26000_task1_dataset-transition_change_issue_upsampled_prompts_v1/*/0.mp4' \
...
from omnidreams._src.imaginaire.utils.context_managers import distributed_init
from omnidreams._src.imaginaire.utils.easy_io import easy_io
from omnidreams._src.predict2.inference.interpolator_lib import Interpolator
from omnidreams._src.predict2.inference.utils import (
    get_filepaths,
    numpy2tensor,
    read_video,
    set_s3_backend,
