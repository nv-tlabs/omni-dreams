...
"""
PYTHONPATH=. streamlit run omnidreams/_src/predict2/inference/text2image.py --server.port 2222
"""
...
from omnidreams._src.predict2.datasets.utils import IMAGE_RES_SIZE_INFO
...
class Text2ImageInference:
    def __init__(self, experiment_name: str, ckpt_path: str, s3_credential_path: str):
        ...
        model, config = load_model_from_checkpoint(
            ...
            config_file="omnidreams/_src/predict2/configs/text2world/config.py",
