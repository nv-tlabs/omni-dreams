...
CUDA_VISIBLE_DEVICES=0 PYTHONPATH=. python omnidreams/_src/predict2/inference/video2world.py \
...
from omnidreams._src.predict2.inference.get_t5_emb import get_text_embedding
...
class Video2WorldInference:
    ...
    def __init__(
        ...
        config_file: str = "omnidreams/_src/predict2/configs/video2world/config.py",
        ...
        if TYPE_CHECKING:
            from omnidreams._src.predict2.models.video2world_model_rectified_flow import Video2WorldModelRectifiedFlow
