...
from omnidreams._src.imaginaire.flags import INTERNAL, SMOKE
...
from omnidreams._src.imaginaire.utils.embedding_concat_strategy import EmbeddingConcatStrategy as EmbeddingConcatStrategy
from omnidreams._src.predict2.models.utils import load_state_dict, load_state_dict_from_folder
from omnidreams._src.predict2.text_encoders.reason1 import QwenVLBaseModel
...
class TextEncoder:
    def __init__(self, config: TextEncoderConfig, device: str = "cuda"):
        ...
        from omnidreams._src.imaginaire.utils.checkpoint_db import get_checkpoint_path
