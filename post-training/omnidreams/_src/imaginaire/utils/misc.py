...
from omnidreams._src.imaginaire.utils.distributed import all_gather_tensor
from omnidreams._src.imaginaire.utils.easy_io import easy_io
from omnidreams._src.imaginaire.utils.timer import Timer
    ...
    def generate_report(self, iteration):
        if self.enabled and iteration % self.report_freq == 0:
            ...
            if distributed.get_rank() == 0:
                ...
                import omnidreams._src.imaginaire.utils.launch

                if omnidreams._src.imaginaire.utils.launch.S3_READY and (iteration % (5 * self.report_freq) == 0) and self.save_s3:
                    easy_io.dump(
                        wandb_info,
