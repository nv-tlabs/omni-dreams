...
from omnidreams._src.imaginaire.utils.misc import Color
...
class TrainerConfig:
    if TRAINING:
        ...
        from omnidreams._src.imaginaire.utils import callback
...
def load_config(config_path: str, opts: list[str], enable_one_logger: bool = False) -> Config:
    from omnidreams._src.imaginaire.serialization import from_yaml, load_callable
    ...
    if enable_one_logger:
        try:
            ...
            from omnidreams._src.imaginaire.utils.one_logger.one_logger_override_utils import override_one_logger_callback
