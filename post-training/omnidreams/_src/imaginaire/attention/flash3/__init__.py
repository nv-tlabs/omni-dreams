...
if FLASH3_SUPPORTED:
    from omnidreams._src.imaginaire.attention.flash3.functions import flash3_attention

else:
    from omnidreams._src.imaginaire.attention.flash3.stubs import flash3_attention
