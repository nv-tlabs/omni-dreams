...
import omnidreams._src.imaginaire.datasets.webdataset.webdataset
...
class DataLoader(webdataset.WebLoader):
    ...
    def __init__(self, dataset: omnidreams._src.imaginaire.datasets.webdataset.webdataset.Dataset, batch_size: int = 1, *args, **kw):  # type: ignore
