...
import omnidreams._src.imaginaire.datasets.webdataset.utils.stream as stream_module
from omnidreams._src.imaginaire.datasets.webdataset.utils.stream import RetryingStream
...
with patch("time.sleep"):  # Skip sleep delays
    with patch("omnidreams._src.imaginaire.datasets.webdataset.utils.stream.log"):  # Suppress retry logs
        try:
...
with patch("time.sleep"):
    with patch("omnidreams._src.imaginaire.datasets.webdataset.utils.stream.log"):
        try:
