        ...
        if self.name.startswith("Qwen/Qwen2"):
            ...
            if self.is_vision_tokenizer:
                ...
                if fps_list:
                    ...
                    if all(fps == first_fps for fps in fps_list):
                        processor_kwargs["fps"] = first_fps
                    else:
                        raise ValueError("Mixed-FPS video batches are not supported by the Qwen processor.")
...
if __name__ == "__main__":
    """
    PYTHONPATH=. python3 omnidreams/_src/reason1/tokenizer/processor.py
    """
