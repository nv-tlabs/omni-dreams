...
from omnidreams._src.imaginaire.flags import FLAGS, VERBOSE
...
_LOGGER_INCLUDE = [
    "omnidreams._src.imaginaire.utils.checkpoint_db",
    "omnidreams._src.imaginaire.trainer",
    "*.callbacks.*",
]
_LOGGER_EXCLUDE = [
    "*._*",
    "projects.*",
    "omnidreams._src.imaginaire.*",
]
